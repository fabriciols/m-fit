...
\hspace*{0.65cm}ISO - A Organização Internacional para Padronização (em língua inglesa: "International Organization for Standardization - ISO).
Popularmente conhecida como ISO, é uma entidade que atualmente congrega os grémios de padronização/normalização de 170 países.
