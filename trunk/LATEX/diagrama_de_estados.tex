...
\item{\textbf{Calculo das Derivadas}

Sistema entra no estado em que é feito o cálculo das derivadas
do RVH
}

\item{\textbf{Obtenção da Derivada Máxima}
...
\item{\textbf{Obtenção da Derivada Mínima}
...
detectados transisções do tipo dissolve.
