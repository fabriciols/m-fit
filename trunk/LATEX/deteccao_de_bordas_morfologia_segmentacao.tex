...
\hspace*{0.65cm}COLOCAR REFERENCIAAAAAAAAAAA A Supressão não Máxima
consiste na eliminação dos pixels da região da borda que não
possuírem magnitude máxima. Como visto no início desta seção, as
bordas são representadas por pixels que possuem gradiente de alta
magnitude. Devido à ruídos presentes na imagem, após os processos de
...
somente 1 pixel representando 1 ponto de borda.

\hspace*{0.65cm}Para evitar descontinuidades das bordas detectadas, é utilizado
o processo de histerese, ou limiarização adaptativa. Este processo consiste em
...
aceito como borda;
\item Se for a luminância do pixel for menor que $T_{2}$, este pixel será automaticamente
rejeitado;
