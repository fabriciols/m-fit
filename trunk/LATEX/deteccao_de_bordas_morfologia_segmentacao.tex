...
de bordas de uma imagem, é a utilização do operador de Canny. Este operador,
diferentemente do operador Sobel, detecta as bordas de forma mais precisa,
visto que suas bordas são mais estreitas (1 pixel) [colocar referencia].
Isto se deve ao fato deste operador se basear em três conceitos, os quais
são considerados conceitos básicos para um bom detector de bordas [colocar ref],
são eles:
