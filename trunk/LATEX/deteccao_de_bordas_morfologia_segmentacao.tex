...
Devido à ruídos presentes na imagem, após os processos de convolução
da imagem, podem haver diversos pixels representando um único ponto
de borda verdadeiro devido à existência de ruídos na imagem. Porém,
aquele que possuir o gradiente com maior magnitude é o candidato
mais forte para representar a borda. Através do processo de
supressão não máxima, os pixels de magnitude não máxima são
eliminados, restando somente 1 pixel representando 1 ponto de borda,
o que melhora a performance do filtro e atende ao terceiro critério
...
de bordas pode ser visto na Figura COLOCAR A FIGURA!
