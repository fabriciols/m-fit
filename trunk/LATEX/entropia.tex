...
\hspace*{0.65cm}A idéia era a seguinte: imagine que um transmissor envie a mensagem
"bom dia", letra a letra. Ao emitir as primeiras letras, o receptor
recebe as letras "b", "o", "m", espaço, "d" e o "i". O "a" final é 
a letra mais inútil, pois a probabilidade de ocorrência dela é muito
grande para que a mensagem faça sentido, ou seja, ela tem uma 
quantidade de informação muito menor do que as primeiras letras.
