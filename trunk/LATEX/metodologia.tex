...
\subsection{Cálculo da Variância para os pontos do Ritmo Visual \label{met_dissolve_cariancia}}

Para cada ponto do Ritmo Visual, é calculada a Variância. Podemos assim, obter
o comportamento da Variância do frame para futura detecção do dissolve.

\subsection{Derivada dos pontos da Variância \label{met_dissolve_derivada_variancia}}

A derivada é aplicada para todos os pontos de Variância calculados 
para analisarmos os maiores intervalos formados. Caso a representação resultante
apresente intervalos maiores que o esperado, o dissolve está presente neste frame.
