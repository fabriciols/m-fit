...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item{Cálculo da Diagonal Principal deste Frame;}
        \item{Obtenção do Histograma desta diagonal;}
        \item{Cálculo da Variância dos frames do vídeo.}
    \end{enumerate}
    ...
    Ritmo visual por histograma, são verificados as médias dos pontos de luminância dos próximos 7 frames do vídeo.
    Caso as médias estejam em ordem crescente ou decrescente, este frame é um possível ponto de dissolve.}


    \item{\textbf{Derivada dos possíveis pontos de Dissolve:} Para os possíveis pontos de Dissolve,
    a derivada destes pontos é calculada, comparando os resultados obtidos a um limiar definido.}
    ...
    para cada ponto definido como início do Dissolve, é verificado seu nível de luminância.
    Caso o nível de luminância seja proximo ao preto, este ponto não será considerado um dissolve,
    pois este fator indica que esta transição representa um fade e não um dissolve;}
