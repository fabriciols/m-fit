...
\begin{enumerate}
    ...
    \end{figure}
        ...
        Tendo as derivadas calculadas, é feita a análise, a fim de encontrar padrões de fade-in e fade-out,
              os quais podem ser vistos na Figura \ref{img_vrhd_fade_in_out}.

        Este array de derivadas é percorrido ponto a ponto, em busca de intervalos onde a derivada sofre uma variação, como nas figuras citadas acima.

        Para que a variação seja analisada pelo sistema, esta precisa atender as seguintes condições:
        ...
        O ponto final desta variação é determinado quando a variação
        tornar-se constante.

        Sob posse desta variação (que variação???? aqui acho q era legal vc explicar de novo... como a explicação ta
        extensa o leitor se perde... tipo eu! aueuahueh), o sistema checa as seguintes condições:
