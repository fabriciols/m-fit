...
\begin{enumerate}
    ...
    \begin{figure}[h|top]
        ...
        fade-in.} \label{img_met_fadein_rvh}
    \end{figure}

    \item{\textbf{Cálculo das Derivadas do RVH:} Obtido o RVH, será
    calculada a sua primeira derivada. A partir desta nova curva, será
    ...
    manter-se constante, e é neste momento em que a derivada atingirá o
...
\begin{enumerate}
    ...
    \item{\textbf{Derivada Segunda da curva de Variância:} A partir da curva do gráfico da variância, é cálculado a
