...
\begin{enumerate}
    \item{\textbf{Vídeo:} É feita a entrada do vídeo no qual será realizada a detecção dos Fades.}
    ...
    \begin{figure}[h|top]
        ...
        \caption{Trecho do RVH derivado de uma sequência que contém uma transição do tipo fade-in, seguida de um fade-out. Eixo X representa os \textit{frames} do vídeo, eixo Y representa a derivada da luminância do \textit{frame}}
    ...
    \end{figure}
        ...
        \begin{enumerate}
        \item{ O intervalo da variação deve conter mais do que 10 Frames, visto que valores abaixo deste limiar podem evidenciar um Corte;}
        ...
        \begin{enumerate}
        \item{Fade-in  : O primeiro ponto da variação é um Frame com predominância de cor preta.}
        \item{Fade-out : O último ponto da variação é um Frame com predominância de cor preta.}
        \end{enumerate}
     }
