...
\begin{enumerate}
    ...
    Ritmo visual por histograma, são verificados as médias da luminância dos próximos 7 frames do vídeo.
    ...
    serão calculadas as suas derivadas, as quais serão submetidas a um limiar.}

    \item{\textbf{Detecção do Dissolve:} Caso os pontos em questão forem todos menores que o limiar,
    o primeiro ponto será indicado como o início do Dissolve.}
    ...
    Caso o nível de luminância seja próximo a 0, este ponto não será considerado um dissolve,
    visto que isto indica que esta transição pode representar um fade e não um dissolve;}
