...
\begin{enumerate}
    ...
    \end{figure}
		...
		Tendo as derivadas calculadas, o sistema começa a analizá-las, à fim de encontrar padrões de fade-in e fade-out,
			  o qual pode ser visto na Figura \ref{img_vrhd_fade_in_out}.
