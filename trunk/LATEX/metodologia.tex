...
\begin{enumerate}
    ...
    \item{\textbf{Verifica pontos de dissolve com 7 frames seguintes:} A partir dos pontos do Ritmo visual por historgrama, é verificado
    os próximos 7 frames. Caso estes frames estejam em ordem crescente ou decrescente, este frame é um possível ponto de dissolve.}
