...
\item Obtenção do valor máximo deste histograma.
\item Os passos 1-3 sao repetidos para todos os frames, e os pontos obtidos com o passo 3, são agrupados.
\end{enumerate}
...
\hspace*{1.25cm}A figura \ref{img_rvh} representa os passos para a
criacção do $RVH$. O passo 3 é representado pela reta horizontal
vermelha no histograma da diagonal.

\hspace*{1.25cm}Matematicamente:
...
pontos de transição das tomadas no vídeo $\bigvee$

\hspace*{0.65cm}No $RVH$ também serão
aplicadas derivadas para uma análise posterior, afim de encontrarmos
transições do tipo fade-in/out e dissolve.
