...
\begin{enumerate}
    ...
    os próximos 7 pontos. Caso estes pontos estejam em ordem crescente, é aplicada a primeira derivada destes pontos, comparando os valores
    obtidos da derivada com threshold definido.}
	
    \item{\textbf{Dissolve detectado:} Caso os pontos em questão forem todos menores que o threshold,
