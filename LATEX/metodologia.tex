...
\begin{enumerate}
    ...
    \item{\textbf{Variância dos frames do Vídeo:} A partir de cada diagonal do frame do vídeo $V$, é calculado um desvio padrão $DP_V$.
    A variância $VAR(V)$ é igual ao $ VAR(V) = DP_V^2 $.}

    \item{\textbf{Derivada Segunda da curva de Variância:} A pártir da curva do gráfico da variância, é cálculado a sua derivada segunda, com o
    objetivo de limitar cada vez as mais os pontos de variação da
    curva.}
