...
\begin{enumerate}
    ...
    observações realizadas em vídeos de teste em que ocorrem o Dissolve foi constatado que em média,
    são necessários 7 pontos. Se estes pontos possuírem um comportamento crescente ou decrescente, o primeiro
