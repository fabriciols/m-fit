...
\begin{figure}[h|top]
 ...
 \caption{Transformação da diagonal principal dos \textit{frame}s de um
...
processo de transformação das diagonais principais dos \textit{frame}s $1$,
...
\item Os passos 1, 2 e 3 são repetidos para todos os \textit{frame}s, e os pontos obtidos com o passo 3, são agrupados.
\end{enumerate}
