...
\hspace*{0.65cm}A imagem \ref{img:rv_batman} mostra o Ritmo Visual
...
sobre o Ritmo Visual (\ref{img:mapa_batman}).
...
\begin{figure}[h|top]
 ...
 \caption{Ritmo Visual filtrado com o operador de Canny.}
 Fonte: Autor.
...
taxa de acerto de 77,96\%, considerando que para a aplicação do
