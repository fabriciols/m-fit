...
checado se os próximos 7 frames estão em ordem crescente ou decrescente 
para que este frame seja um possível ponto de Dissolve. }
...
Os resultados da derivada são comparados a um limiar definido.}
