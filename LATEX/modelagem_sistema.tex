...
\item{Frame* applyEffect()}
\hspace*{0.65cm}Aplica o efeito de dilatação no Frame.
...
\item{void on_backButton_clicked()}
\hspace*{0.65cm}Trata o botão backward. Volta o vídeo em um frame.

\item{void on_forwardButton_clicked()}
...
\item{void on_transitionsTree_itemSelectionChanged()}
...
\item{void on_effectsTree_itemClicked()}
...
\item{void on_transitionsTree_itemClicked()}
...
\item{void on_transitionsTree_itemDoubleClicked()}
...
\item{void resetROI()}
\hspace*{0.65cm}Inicializa a ROI (Region Of Interest).

\item{Video(char *filename_cy)}
...
Quando for aplicado um efeito, o vídeo preview exiba o primeiro
frame da tomada editada.
